...
import { CollegeMark, ConclaveLogo } from "@/components/logo";
    ...
    <footer className="border-t border-paper/10">
      <div className="mx-auto flex max-w-[88rem] flex-col gap-8 px-4 py-10 sm:px-6 md:flex-row md:items-center md:justify-between lg:px-10">
        <div className="flex items-center gap-5">
          <ConclaveLogo className="w-36 shrink-0 sm:w-44" />
          <div className="flex items-center gap-3">
            <CollegeMark className="size-7 shrink-0 opacity-45" />
            <p className="label leading-relaxed opacity-45">
              An initiative by
              <br />
